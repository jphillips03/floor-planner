 ...
 * 16/9 = 1.777). Ratio values are multiplied by 2.5 to ensure there is padding
 * around floor plan (*2 seems too small, but *2.5 seems ok).
 */
public enum AspectRatio {
     ...
     * multiplied by 2.5 to ensure padding around floor plan.
     *
     * @param value Value to set for constant.
     */
    private AspectRatio(float value) {
        this.value = value * 2.5f;
    }
}
